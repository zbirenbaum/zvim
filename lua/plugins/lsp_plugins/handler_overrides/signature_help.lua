local api = vim.api
local M = {}
local helper = require('plugins.lsp_plugins.handler_overrides.helper')
...
M.status_line = function(size)
  ...
  local data = { hint = status_line.hint, label = status_line.label, range = status_line.range, doc = status_line.doc }
